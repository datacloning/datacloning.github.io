...
<button type="button" class="btn btn-default"><a href="peter.solymos.org">Button with link</a></button>

<button type="button" class="btn btn-primary btn-lg btn-block">Block wide button</button>
