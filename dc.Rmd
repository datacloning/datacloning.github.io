...
<ul class="pager">
<li class="next"><a href="{{ site.baseurl }}/courses/{{ page.course.year }}/{{ page.course.location | downcase }}/{{ page.course.next }}.html">Install <i class="fa fa-caret-right"></i></a></li>
</ul>
