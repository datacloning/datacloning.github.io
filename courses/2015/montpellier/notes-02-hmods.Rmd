...
One of the most important results from Neyman and Scott (1949) is that as the sample size increases, $$\hat{\sigma}_{\varepsilon}^2 \rightarrow \frac{\sigma_{\varepsilon}^2}{2}$$. It is almost obvious that we cannot estimate  consistently (although it is an unbiased estimator). 
